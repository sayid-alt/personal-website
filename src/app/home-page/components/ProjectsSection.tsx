...
const projects = [
  {
    ...
    tags: ['Data Analytics', 'Machine Learning', 'Python', 'Tableau', 'Data Visualization'],
    image: 'https://www.datascienceportfol.io/static/profile_pics/pr0_819512BFB2DC77E43760.png',
    imageAlt:
  ...
  },
  {
    ...
    tags: ['Customer Segmentation', 'Python', 'Looker Studio', 'Data Visualization'],
    image: 'https://www.datascienceportfol.io/static/profile_pics/pr1_A3469C2E181CE359D2B9.png',
    imageAlt:
  ...
  },
  {
    ...
    tags: ['NLP', 'K-Means Clustering', 'API Integration', 'Feature Engineering', 'Python'],
    image: 'https://www.datascienceportfol.io/static/profile_pics/pr2_50B456F918466C774FE4.png',
    imageAlt:
  ...
  },
  {
    ...
    tags: ['Deep Learning', 'CNN', 'LSTM', 'GRU', 'TensorFlow', 'Keras-Tuner', 'Python'],
    image:
...
export default function ProjectsSection() {
  ...
  return (
    <section id="projects" ref={sectionRef} className="py-24 relative" aria-label="Projects">
      {/* Section ambient */}
      <div
        ...
        >
          ...
          <h2 className="font-display text-4xl md:text-5xl font-semibold text-[#E2E8F0] leading-tight">
            ...
            <span
              ...
              style={{
                backgroundImage: 'linear-gradient(135deg, #22D3EE 0%, #67E8F9 60%, #F59E0B 100%)',
          ...
          {projects.map((project, i) => (
            <a
              ...
              className={`reveal reveal-delay-${(i % 3) + 1} group 
                          ...
                          transition-all duration-500 hover:-translate-y-2 hover:shadow-[0_24px_48px_rgba(0,0,0,0.4)] 
            ...
            >
              ...
              <div className="p-6">
                {/* Cyan line reveal */}
                <div className="line-reveal mb-4" style={{ background: project.accent }} />
