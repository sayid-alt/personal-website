        ...
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div>
            ...
            <h1
              ...
              style={{
                animation:
                  "fadeInUp 0.9s cubic-bezier(0.22,1,0.36,1) 0.2s both",
              }}
            >
              Sayid Muhammad
              <br />
            ...
            <div
              ...
              style={{
                animation:
                  "fadeInUp 0.9s cubic-bezier(0.22,1,0.36,1) 0.35s both",
              }}
            >
              <p className="text-lg font-medium text-[#22D3EE] mb-1">
            ...
            <p
              ...
              style={{
                animation:
                  "fadeInUp 0.9s cubic-bezier(0.22,1,0.36,1) 0.45s both",
              }}
            >
              Informatics Engineering graduate bridging raw data and executive
              decision-making through ML research, predictive modeling, and
            ...
            <div
              ...
              style={{
                animation:
                  "fadeInUp 0.9s cubic-bezier(0.22,1,0.36,1) 0.55s both",
              }}
            >
              <a
                href="#projects"
