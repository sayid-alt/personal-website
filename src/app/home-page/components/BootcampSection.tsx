  ...
  return (
    ...
    >
	  ...
	  <div className='grid md:grid-cols-3 gap-6'>
		<div>
			<div className='mb-5'>
				<p className={`text-xs font-semibold uppercase tracking-widest text-[var(--hover-color)]`}
					style={{ 
				...
				<div className='grid md:grid-cols-2 justify-around'>
					<div className='flex items-start gap-4'>
						...
						<div className='grid grid-rows-2 gap-1'>
							<h2 className={`text-2xl font-bold text-[var(--hover-color)] leading-tight`}
								style={{ 
									'--hover-color': item.accent,
								} as React.CSSProperties}
							>{item.org}</h2>
					...
					<div className='flex justify-end items-start'>
						<a className={`inline-flex items-center gap-2 bg-[#ffffff] text-[#070B14] px-8 py-1.5 cursor-pointer rounded-full font-bold text-sm hover:bg-[var(--hover-color)] transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_8px_24px_var(--hover-shadow)]`}
				...
				<div className='grid md:grid-cols-2 gap-2'>
					...
					<div>
						<div className='flex items-center gap-2 mb-2'>
							<Icon name="AcademicCapIcon" size={16} className="text-[#22D3EE]" style={{color: item.accent}} />
							<h3 className={`text-xs font-semibold uppercase tracking-widest text-[var(--hover-color)]`}
								style={{ 
								'--hover-color': item.accent,
							} as React.CSSProperties}
							>LEARNING CURRICULUM</h3>
						</div>
						{item.highlights && (
					...
					<div className='group glass-card rounded-2xl p-4 hover:bg-white/5 transition-all duration-500 hover:-translate-y-1 relative'>
						...
						<h3 className='text-xs font-semibold uppercase tracking-widest mb-1'>{item.capstone?.title}</h3>
